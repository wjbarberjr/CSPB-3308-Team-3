...
class TestTeam3APIFunctions(unittest.TestCase):
    ...
    def test_add_user(self):                                               #Test the add_user function
        self.test_db_filename = 'test_user_database.db'
        team3API.add_user('John', 'Doe', '1990-01-01', 'Male', 'john_doe', 'john.doe@example.com', self.test_db_filename) #Add user and then check it
        ...
        expected_user_data = ('John', 'Doe', '1990-01-01', 'Male', 'john_doe', 'john.doe@example.com')
    ...
    def test_edit_user(self):                                              #Test the edit_user function
        self.test_db_filename = 'test_user_database.db'
        team3API.add_user('Jane', 'Doe', '1995-05-05', 'Female', 'jane_doe', 'jane.doe@example.com', self.test_db_filename)
        ...
        team3API.edit_user(user_id, 'John', 'Doe', '1990-01-01', 'Male', 'john_doe', 'john.doe@example.com', self.test_db_filename)
        ...
        expected_user_data_after_edit = ('John', 'Doe', '1990-01-01', 'Male', 'john_doe', 'john.doe@example.com')
